...
class Dispatcher:
    ...
    def _dispatch_prepro(self):
        meta = self._config_to_dict(self.config.PreproConfig)
        meta.update(self.common)
        return DataPreprocessor(meta)

    def _dispatch_classifier(self):
        meta = self._config_to_dict(self.config.ClassifierConfig)
        meta.update(self.common)
    ...
    def dispatch_handlers(self, handlers):
        '''
        The main (only) public method. Takes a tuple of handlers 
        and sets them up in a coordinated way.
        ...
        Returns:
            a tuple of instantiated handlers.
        ...
        mapping = {Pipeline: self._dispatch_pipeline,
                   ...
                   DataPreprocessor: self._dispatch_prepro,
